...
const I18N = {
  en: {
    ...
    "exp.t3.s": "Force Field Development & AI Protein Sequence Design",
    "exp.t3.d": "Developed the TIP4P-B and OPC3-B solvent models, the BSFF1 RNA force field, and GPD, a Graphormer-based de novo protein sequence-design model. Redesigned CALB esterase with <50% sequence identity — 37.5% of sequences active, top activity 2× wild-type, with altered substrate selectivity. Published in JCIM, JCTC, and IJBM.",
    ...
    "proj.emelia.mac": "macOS · Apple Silicon · v1.0.5",
    "proj.emelia.win": "Windows · x64 · v1.0.5",
  ...
  zh: {
    ...
    "exp.t3.s": "力场开发与 AI 蛋白质序列设计",
    "exp.t3.d": "开发溶剂化模型 TIP4P-B、OPC3-B，RNA 分子力场 BSFF1，以及基于 Graphormer 架构的从头蛋白质序列设计模型 GPD。重新设计 CALB 酯水解酶，序列同源性小于 50%，37.5% 的序列有活性，活性最高提升至野生型 2 倍，并具有底物选择性。论文发表于 JCIM、JCTC、IJBM。",
    ...
    "proj.emelia.mac": "macOS · Apple 芯片 · v1.0.5",
    "proj.emelia.win": "Windows · x64 · v1.0.5",
